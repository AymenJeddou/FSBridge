...
const Professeurs = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {profs.length === 0 ? (
        <div className="retro-card p-12 text-center text-muted-foreground">Aucun professeur listé pour le moment.</div>
      ) : (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {profs.map((p) => (
            <div key={p.id} className="retro-card retro-card-hover p-6">
